...
int main() {
	...
	for (int i = 0; i < 100000; i++)
		set2.insert(rand() % (100 - 99 + 1) + 100);

	AVL_Tree<int> t23(1000);
	set<int> set3;

	for (int i = 0; i < 1000; i++)
		set3.insert(rand() % (100 - 99 + 1) + 100);
	...
	std::cout << "\nset::insert (10): " << sav / 1000 << "ns" << endl;
	std::cout << "set::insert (1000): " << sav2 / 1000 << "ns" << endl;
	std::cout << "set::insert (100000): " << sav1 / 1000 << "ns" << endl;

	//-----------------------------------УДАЛЕНИЕ-------------------------------
	cout << "\n-------Удаление: сравнение с std::set-------\n\n";
	...
	std::cout << "\nset::erase (10): " << sav / (2000 + count12) << "ns" << endl;
	std::cout << "set::erase (1000): " << sav2 / (2000 + count32) << "ns" << endl;
	std::cout << "set::erase (100000): " << sav1 / (2000 + count22) << "ns\n" << endl;
...
/*
 ...
 --------------------------------
77 207 308 348 370 405 420 452 465 509 518 535 611 676 925
 --------------------------------
Any input iterator range : 77 207 308 348 370 405 420 452 465 509 518 535 611 676 925
0
 --------------------------------
...
AVL_Tree::insert (10): 152ns
AVL_Tree::insert (1000): 172ns
AVL_Tree::insert (100000): 188ns

multiset::insert (10): 927ns
multiset::insert (1000): 949ns
multiset::insert (100000): 1208ns

-------Удаление: сравнение с std::multiset-------

AVL_Tree::erase (10): 453ns
AVL_Tree::erase (1000): 471ns
AVL_Tree::erase (100000): 485ns

multiset::erase (10): 653ns
multiset::erase (1000): 890ns
multiset::erase (100000): 15718ns
